            ...
            reply_markup=InlineKeyboardMarkup(
                [
                    [
                        ...
                        InlineKeyboardButton("【◉ Librarian Institute ◉】", url="https://t.me/Librarian_Institute")
                    ],
                    [
...
async def main(bot, message):
    if message.chat.type == "private":
        ...
        if message.from_user.id in Config.BANNED_USERS:
            await message.reply_text("Sorry, You are banned!\n\nContact [【◉ Owners ◉】](https://t.me/Animesh_941/53)",
                                     disable_web_page_preview=True)
            return
        ...
        if Config.UPDATES_CHANNEL:
            ...
            try:
                ...
                if user.status == "kicked":
                    await cmd.message.edit(
                        text="Sorry Sir, You are Banned to use me. Contact my [【◉ Team Librarian ◉】](https://t.me/Team_Librarian).",
                        parse_mode="markdown",
                        disable_web_page_preview=True
                    )
                    return
